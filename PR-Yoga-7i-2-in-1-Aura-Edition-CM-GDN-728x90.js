...
lib.ssMetadata = [
		{name:"PR_Yoga_7i_2_in_1_Aura_Edition_CM_GDN_728x90_atlas_1", frames: [[730,0,50,50],[0,0,728,90],[0,92,728,90],[0,184,728,90],[0,276,728,90],[0,368,728,90],[0,460,728,90],[0,552,728,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Yoga_7i_2_in_1_Aura_Edition_CM_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRYoga7i2in1AuraEditionCMGDN728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(101).to({_off:false},0).to({_off:true},49).wait(180));

	// Layer_2
	this.instance_5 = new lib.Frame2();
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(50).to({_off:false},0).to({_off:true},51).wait(229));
...
// library properties:
lib.properties = {
	id: 'C4F222B364C97C45AA019767B39B5A4E',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Yoga_7i_2_in_1_Aura_Edition_CM_GDN_728x90_atlas_1.png", id:"PR_Yoga_7i_2_in_1_Aura_Edition_CM_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['C4F222B364C97C45AA019767B39B5A4E'] = {
